    ...
    try {
      if (!imageUrl) {
        toast({
          ...
          description:
            'É preciso adicionar e aguardar o upload de uma imagem antes de realizar um novo upload.',
        });
      ...
      toast({
        ...
        description: 'Ops...ocorreu um erro ao tentar cadastrar a sua imagem.',
      });
    } finally {
      reset();
      closeModal();
